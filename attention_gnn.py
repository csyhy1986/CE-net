...
class AttentionalGNN(nn.Module):
    def __init__(self, feature_dim: int, layer_names: list):
        ...
        self.layers = nn.ModuleList([
            AttentionalPropagation(feature_dim, 2)
    ...
    def forward(self, desc0, desc1):
        ...
        for i in range(n):
            ...
            delta0, prob0 = layer(desc0, src0)
            delta1, prob1 = layer(desc1, src1)
            prob.append({'img': 'imgL', 'layer':i, 'name': name, 'p':prob0})
            prob.append({'img': 'imgR', 'layer':i, 'name': name, 'p':prob1})
            desc0, desc1 = (desc0 + delta0), (desc1 + delta1)
            

        return desc0, desc1, prob
